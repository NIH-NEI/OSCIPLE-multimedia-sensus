...
if __name__ == "__main__":
	...
	parser.add_argument('filetype', help="Which file extension should be compared (hashfiles can have multiple but this detects only one at a time)")
	args = parser.parse_args()
 
	dupefinder(args.hashcsvfile, args.dupefilepath, args.filetype)